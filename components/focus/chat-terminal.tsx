  ...
  return (
    <div ref={containerRef} className="flex-1 flex flex-col h-full bg-gradient-to-br from-[#0a0b0f] via-[#0d0e11] to-[#111318] min-w-0 relative">
      ...
      {hasStartedChatting && (
        <>
          {/* Chat Header */}
          <div className="relative p-4 border-b border-white/5 flex-shrink-0 backdrop-blur-sm bg-white/[0.02]">
            <div className="flex items-center space-x-3">
              <div className="relative">
                <div className="w-8 h-8 bg-gradient-to-r from-[#7f5af0] via-[#9333ea] to-[#6366f1] rounded-full flex items-center justify-center shadow-lg shadow-purple-500/25 ring-1 ring-purple-500/20">
                  <Bot className="h-4 w-4 text-white" />
                </div>
                <div className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-[#10b981] rounded-full border-2 border-[#0d0e11] flex items-center justify-center">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center space-x-2">
                  <h2 className="font-bold text-[#e6ebf4] text-lg bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                    Toro Assistant
                  </h2>
                  <Badge className="bg-[#10b981]/20 text-[#10b981] border-[#10b981]/30 text-xs px-2 py-0.5">
                    Online
                  </Badge>
                </div>
                <div className="text-sm text-[#9ca3af] flex items-center space-x-2">
          ...
          {/* Messages */}
          <div className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-purple-500/30 min-h-0">
